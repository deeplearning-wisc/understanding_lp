...
from models.llavaov import load_llavaov
...
def forward(messages, image, model, processor, target_tokens):
    ...
    image_tokens_idx = torch.where(inputs.input_ids == 151646)[1]
...
if __name__ == "__main__":
    ...
    output_dir = os.path.join(data_path, "llavaov")
